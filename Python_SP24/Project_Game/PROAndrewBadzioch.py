...
Description: The classic game of "Rock, Paper, Scissors" where the player competes against the computer. Whe starting the game, the player
            ...
            user wins, loses, or draws with the computer. This game will continue until the playerr opts out by typing 'n' when prompted after
            each round.
'''
...
# Constants used for the introduction messages, create a separation line, and welcome the player to the game.
...
# stating the results (tie, user won, or computer won) as well as using the dictionary to give the corresponding definition for better readability.
def getWinner(userChoice, compChoice):
    ...
    if (userChoice == 'r' and compChoice == 's'):
        ...
        return (f"Sorry, the computer chose {choices[compChoice]} and won.")
